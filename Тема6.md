...
dict_maker(name='Михфил', age=31, weight=70, eyes_color='blue')
pprint(my_dict)
```
...
### Результат.
![image](https://github.com/llubyanskikh/Software_engineering0/assets/147454826/56f64268-1491-4a79-89d1-9e424b4edc65)
